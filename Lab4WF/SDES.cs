...
namespace ECB
{
    ...
    class SDES
    {
        ...
        public static Tuple<BitArray, String> MakeS_DES(BitArray textBits, String keyText, Boolean type)
        {
            ...
            return Tuple.Create(MakeTransformation(textBits, k1, k2), log.ToString());
        }
